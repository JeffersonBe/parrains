...
<body>
  <div class="row">
      <dl class="tabs">
        <dd class="active"><a href="#parrain">Choisir son parrain</a></dd>
        <dd><a href="#parraincoeur">Choisir son parrain de cœur</a></dd>
      </dl>

      <ul class="tabs-content">
        <li class="active" id="parrainTab">
